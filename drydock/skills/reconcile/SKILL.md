...
A plan with all waves PASS. If any wave lacks a PASS report, refuse: reconciling
...
whose gate declares a human approval must show it recorded as `CLOSED, approved
